...
<main>
    <div class="container-fluid">
        ...
        <hr color="cyan"></hr>
            <div>
                <p>
                    <a href="<?php echo base_url(); ?>/menus/nuevo" class="btn btn-primary">Agregar</a>
                    <a href="<?php echo base_url(); ?>/menus/eliminados" class="btn btn-warning">Eliminados</a>
                </p>
            </div>
                ...
                <table class="table table-bordered" id="reportes" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . '/menus/editar/' . $dato['id']; ?>;" class="btn btn-success">
                            <i class="fas fa-pencil-alt fas-lg"></i></a>
                            <a href="#" data-href="<?php echo base_url() . '/menus/eliminar/' . $dato['id']; ?>;" 
