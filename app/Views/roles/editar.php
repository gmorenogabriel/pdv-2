                    ...
                    <select class="form-control" id="id_unidad" name="id_unidad" required>
                        ...
                        <?php foreach($unidades as $unidad) { ?>
                            <option value="<?php echo $unidad['id']; ?>"                                    
                                <?php if($unidad['id'] == $rol['id_unidad']){ 
                            ...
                            <select class="form-control" id="id_categoria" name="id_categoria" required>
                                ...
                                <?php foreach($categorias as $categoria) { ?>
                                    <option value="<?php echo $categoria['id']; ?>"                                    
                                        <?php if($categoria['id'] == $rol['id_categoria']){ 
                ...
                <div class="form-group col-md-6">
                    <div class="input-group-prepend">
                        ...
                        <input type="input"  
                            ...
                            aria-label="Sizing example input" 
                            aria-describedby="inputGroup-sizing-default"
                            value="<?php echo $rol['precio_compra']; ?>" 
                            required/>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    <div class="input-group-prepend">
                        ...
                        <input type="input"  
                            ...
                            aria-label="Sizing example input" 
                            aria-describedby="inputGroup-sizing-default"
                            value="<?php echo $rol['precio_venta']; ?>" 
                            required/>
                            </div>
                        </div>
                    </div>                                           
                ...
                <div class="form-group col-md-6">
                    <div class="input-group-prepend">
                        ...
                        <input type="input"  
                            ...
                            aria-label="Sizing example input" 
                            aria-describedby="inputGroup-sizing-default"
                            value="<?php echo $rol['stock_minimo']; ?>" 
                            required/>
                    </div>
                </div>
                    ...
                    <div class="input-group-prepend">
                        ...
                        <i class="fa fa-location-arrow" aria-hidden="true"></i>&nbsp; Es Inventariable</span>
                            <select class="form-control" id="inventariable" name="inventariable" required>
                                <option value="1" <?php if($rol['inventariable'] == 1) { 
                                    echo 'selected'; }?>>Si</option>
                                <option value="0" <?php if($rol['inventariable'] == 0) {
                        ...
                        <option value="">Seleccionar Código de Barras</option>
                                <?php foreach($codigosbarras as $codigobarra) { ?>
                                    <option value="<?php echo $codigobarra['id']; ?>"                                    
                                        <?php if($codigobarra['id'] == $rol['id_barcod']){ 
        ...
        <fieldset class="form-group border p-1 col-md-12">
            <legend class="col-md-3 col-form-label pt-0" align="center">Acciones</legend>
                ...
                <div class="col clearfix col-md-12"> 
                    ...
                    <span class="float-right"><a href="<?php echo base_url('rol'); ?>" class="btn btn-primary"><i class="fa fa-undo" aria-hidden="true"></i> Regresar</a>
                </div>         
        <fieldset>
    </form>
</div>
