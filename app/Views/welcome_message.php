...
<head>
	<meta charset="UTF-8">
	<title>Welcome to Punto de Venta</title>
...
<a class="dropdown-item" href="<?= site_url('lang/es'); ?>">Spanish</a>
<a class="dropdown-item" href="<?= site_url('lang/fr'); ?>">French</a>
<a class="dropdown-item" href="<?= site_url('lang/pt'); ?>">Portugal</a>
<h1><?= lang("Text.page_title") ?></h1>
<h2><?= lang("Text.welcome_message") ?></h2>
<h3><?= lang("Text.author_information") ?></h3>
<h4><?= lang("Text.demo_portugal") ?></h4>

<h5><?= config('Custom')->empresaTitulo?></h5>

	<div class="heroe">

		<h1>Welcome to PDV 4 <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
