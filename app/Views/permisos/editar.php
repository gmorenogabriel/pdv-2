...
<main>
    <div class="container-fluid">
        ...
        <form action="<?php echo base_url(); ?>/permisos/actualizar" method="post" autocomplete="off">
            <input type="hidden" id="id" name="id" value="<?php echo $permiso['id']; ?>" />
                    ...
                    <select class="form-control" id="menu_id" name="menu_id" required>
                        <!-- <option value="">Seleccionar Menu</option>-->
                            ...
                            <option value="<?php echo $menu['id']; ?>"                                    
                                <?php if($permiso['menu_id'] == $menu['id']){ 
                                echo 'selected';  }?>><?php echo $menu['nombre']; ?></option>
                            <?php } ?>
                ...
                <label class="radio-inline">
                    <input type="radio"
                        ...
                        <?php if(isset($permiso)){ ?>                            
                            value="1" <?php echo $permiso['read'] == "1" ? "checked":"";?> />SI
                        <?php } ?>                                 
                    </label>
                    ...
                    <label class="radio-inline" >
                        <input type="radio"
                            id="read" name="read" 
                            value="0" <?php echo $permiso['read'] == "0" ? "checked":"";?> />NO
                        </label>
                    </div>
            ...
            <div class="col-12 col-sm-3">
                <label class="radio-inline" >
                    <input type="radio"
                        ...
                        <?php if(isset($permiso)){ ?>
                            value="1" <?php echo $permiso['insert'] == "1" ? "checked":"";?> />SI
                        <?php } ?>                                 
                    </label>
                    ...
                    <input type="radio"
                        id="insert" name="insert" 
                         value="0" <?php echo $permiso['insert'] == "0" ? "checked":"";?> />NO
                    </label>                
            </div>
            ...
            <div class="col-12 col-sm-3">
                <label class="radio-inline" >
                    <input type="radio"
                        ...
                        <?php if(isset($permiso)){ ?>
                            value="1" <?php echo $permiso['update'] == "1" ? "checked":"";?> />SI
                        <?php } ?>                                 
                    </label>
                ...
                &nbsp;&nbsp;&nbsp;
                    ...
                    <input type="radio"
                        id="update" name="update" 
                         value="0" <?php echo $permiso['update'] == "0" ? "checked":"";?> />NO
                    </label>
            </div>
...
<!--   Delete  -->
                ...
                <label class="radio-inline" >
                    <input type="radio"
                        ...
                        <?php if(isset($permiso)){ ?>
                            value="1" <?php echo $permiso['delete'] == "1" ? "checked":"";?> />SI
                        <?php } ?>
                    </label>
                    ...
                    <input type="radio"
                        id="delete" name="delete" 
                         value="0" <?php echo $permiso['delete'] == "0" ? "checked":"";?> />NO
                    </label>
                </div>
                </div>
            </div>                             
